...
```{r}
# Assuming NFL2022_stuffs is your data frame
...
```{r}
NFL2022_stuffs_EPA <- merge(NFL2022_stuffs, NFL2022_epa[, c("play_id", "game_id", "drive", "passer", "receiver", "epa")], 
                            by = c("play_id", "game_id", "drive", "posteam"))

NFL2022_stuffs_EPA <- NFL2022_stuffs_EPA[!is.na(NFL2022_stuffs_EPA$passer), ]
